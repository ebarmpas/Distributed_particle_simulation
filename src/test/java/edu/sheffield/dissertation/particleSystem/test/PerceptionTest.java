...
public class PerceptionTest {
	...
	public void testGeneralVisionInRange() {
		Agent a1 = new Agent(new Vector2D(500, 500), new Vector2D(), new Vector2D(), 1, 1, 1, 1, 100, 100, 100, 100, 100, 100);
		Agent a2 = new Agent(new Vector2D(520, 520), new Vector2D(), new Vector2D(), 1, 1, 1, 1, 100, 100, 100, 100, 100, 100);
	...
	public void testGeneralVisionOutOfRange() {
		Agent a1 = new Agent(new Vector2D(500, 500), new Vector2D(), new Vector2D(), 1, 1, 1, 1, 100, 100, 100, 100, 100, 100);
		Agent a2 = new Agent(new Vector2D(800, 800), new Vector2D(), new Vector2D(), 1, 1, 1, 1, 100, 100, 100, 100, 100, 100);
	...
	public void testBattleVisionInRange() {
		Agent a1 = new Agent(new Vector2D(500, 500), new Vector2D(), new Vector2D(), 1, 1, 1, 1, 100, 100, 100, 100, 100, 100);
		Agent a2 = new Agent(new Vector2D(501, 501), new Vector2D(), new Vector2D(), 0, 1, 1, 1, 100, 100, 100, 100, 100, 100);
	...
	public void testBattleVisionOutOfRange() {
		Agent a1 = new Agent(new Vector2D(500, 500), new Vector2D(), new Vector2D(), 1, 1, 1, 1, 100, 100, 100, 100, 100, 100);
		Agent a2 = new Agent(new Vector2D(530, 530), new Vector2D(), new Vector2D(), 0, 1, 1, 1, 100, 100, 100, 100, 100, 100);
	...
	public void testCanReproduce() {
		...
		Agent a2 = new Agent(new Vector2D(501, 501), new Vector2D(), new Vector2D(), 0, 1, 2, 1, 100, 200, 100, 200, 100, 200);	
	...
	public void testCannotReproduceRange() {
		Agent a1 = new Agent(new Vector2D(500, 500), new Vector2D(), new Vector2D(), 0, 2, 1, 2, 100, 100, 200, 100, 200, 100);
		Agent a2 = new Agent(new Vector2D(510, 510), new Vector2D(), new Vector2D(), 0, 1, 2, 1, 100, 200, 100, 200, 100, 200);	
	...
	public void testCannotReproduceSpecies() {
		Agent a1 = new Agent(new Vector2D(500, 500), new Vector2D(), new Vector2D(), 1, 2, 1, 2, 100, 100, 200, 100, 200, 100);
		Agent a2 = new Agent(new Vector2D(501, 501), new Vector2D(), new Vector2D(), 0, 1, 2, 1, 100, 200, 100, 200, 100, 200);	
