...
public class TestLifeAndDeath {
	...
	public void testReproduction(){
		...
		Agent a2 = new Agent(new Vector2D(600, 600), new Vector2D(), new Vector2D(), 0, 1, 2, 1, 100, 200, 100, 200, 200);			
	...
	public void testBattle() {
		...
		Agent a2 = new Agent(new Vector2D(600, 600), new Vector2D(), new Vector2D(), 1, 1, 1, 1, 100, 100, 100, 50, 100);	
